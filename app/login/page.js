...
const Login = () => {
    ...
    return (
        <div className='text-white container mx-auto'>
            <h1 className=' text-2xl flex justify-center text-center py-5'>Login/Signup to Get your friends support you</h1>
            <div className='flex justify-center'>
                <div className="flex flex-col gap-2 p-10 justify-center items-center md:w-[45%]">
                    <button className="flex  items-center w-full border bg-white border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button className="flex item s-center w-full border bg-white border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    <button onClick={() => { signIn("github") }} className="flex  items-center w-full border bg-white border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
